...
namespace IdentityServer4.EntityFramework.DbContexts
{
    ...
    //    {
    //        var connectionString = "Server=localhost,1433;Database=IDS;UID=sa;Password=Local1234";
    ...
    //        opOptions.ConfigureDbContext(dbContextBuilder);
    //        return new PersistedGrantDbContext(dbContextBuilder.Options, opOptions);
    //    }
    //}
        ...
        where TContext : DbContext, IPersistedGrantDbContext
    {
        ...
        {
            modelBuilder.HasDefaultSchema("ids.persistedgrant");
